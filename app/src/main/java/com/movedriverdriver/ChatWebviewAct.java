...
import com.movedriverdriver.util.GpsStatus;
import com.movedriverdriver.util.SessionSave;
import com.movedriverdriver.util.Utility;

import static com.movedriverdriver.util.ConstantsKt.API_BASE;
import static com.movedriverdriver.util.ConstantsKt.PASS_ID;
import static com.movedriverdriver.util.ConstantsKt.PASS_NAME;
...
public class ChatWebviewAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(ChatWebviewAct.this).load(R.raw.loading_anim).into(imageViewTarget);
        ...
        if (!TextUtils.isEmpty(Id)) {
            link_1 = SessionSave.getSession("chat_node_url", ChatWebviewAct.this) + "?name=" + SessionSave.getSession(PASS_NAME, ChatWebviewAct.this) + "(" + SessionSave.getSession(PASS_ID, ChatWebviewAct.this) + ")&id=" + Id + "&image=" + SessionSave.getSession("p_image_name", ChatWebviewAct.this) + "&type=P" + "&chat_type=" + chat_type + "&to_type=" + to_type;
        }
...
/* link_1 = SessionSave.getSession(DriverCommonData.NODE_URL, ChatWebviewAct.this)+ "?name="+ SessionSave.getSession("Name",ChatWebviewAct.this)+"("
        ...
        if (TextUtils.isEmpty(link_1.trim())) {
            if (type.equalsIgnoreCase("3")) {
                link_1 = SessionSave.getSession("chat_node_url", ChatWebviewAct.this) + "?name=" + SessionSave.getSession(PASS_NAME, ChatWebviewAct.this) + "(" + SessionSave.getSession(PASS_ID, ChatWebviewAct.this) + ")&id=Passenger_Chat_ID_" + SessionSave.getSession(PASS_ID, ChatWebviewAct.this) + "&image=" + SessionSave.getSession("p_image_name", ChatWebviewAct.this) + "&type=P" + "&chat_type=2" + "&to_type=A";
            } else {
                link_1 = SessionSave.getSession("chat_node_url", ChatWebviewAct.this) + "?name=" + SessionSave.getSession(PASS_NAME, ChatWebviewAct.this) + "(" + SessionSave.getSession(PASS_ID, ChatWebviewAct.this) + ")&id=Job_ID_" + trip_id + "&image=" + SessionSave.getSession("p_image_name", ChatWebviewAct.this) + "&type=P" + "&chat_type=1" + "&to_type=D";
            }
        }
...
//        }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            try {
                if (simpleWebView != null) iv.setVisibility(View.GONE);
