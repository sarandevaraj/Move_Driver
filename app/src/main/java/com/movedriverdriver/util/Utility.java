package com.movedriverdriver.util;
...
public class Utility {
    ...
    public static boolean validations(ValidateAction VA, Context con, String stringToValidate) {
        ...
        if (!message.equals("")) {
            DriverCToast.ShowToast(con, message);
        }
        return result;
    }
    ...
    public static AlertDialog alert_view_dialog(final Activity mContext, String title, String message, String success_txt, String failure_txt, Boolean cancelable_val, final DialogInterface.OnClickListener postive_dialogInterface, final DialogInterface.OnClickListener negative_dialogInterface, final String s) {
        if (mContext != null) {
            DriverSystems.out.println("updateGetPassUpdate*****3");
            ...
            alert.setOnShowListener(arg0 -> {
                if (alert != null) {
                    alert.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(DriverCL.getColor(mContext, R.color.button_accept));
                    alert.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(DriverCL.getColor(mContext, R.color.black));
                }
            });
            alert.show();
        }
...
//    }
    ...
    public static void gps_dialog(final Context mContext, String title, String message, String success_txt, String failure_txt, Boolean cancelable_val, final DialogInterface.OnClickListener postive_dialogInterface, final DialogInterface.OnClickListener negative_dialogInterface, final String s) {
        if (mContext != null) {
            ...
            gpsalert.setOnShowListener(arg0 -> {
                if (gpsalert != null) {
                    gpsalert.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(DriverCL.getColor(mContext, R.color.button_accept));
                    gpsalert.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(DriverCL.getColor(mContext, R.color.black));
                }
            });
        }
    }
    ...
    public static void closeDialog(Dialog alert) {
        DriverSystems.out.println("Utility---closeDialog");
        try {
            if (alert != null && alert.isShowing()) {
                alert.dismiss();
                alert = null;
    ...
    public static void actionSheet(final Activity mContext, String title, String success_txt, String failure_txt, Boolean cancelable, AlertListener listener) {
...
//        Colorchange.ChangeColor((ViewGroup) sheetView, mContext);
    ...
    public static void actionSheetCancel(final Activity mContext, String title, String success_txt, String failure_txt, Boolean cancelable, AlertListener listener) {
