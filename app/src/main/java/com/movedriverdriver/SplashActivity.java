...
import com.movedriverdriver.data.apiData.CompanyDomainResponse;
import com.movedriverdriver.driver.DriverMyStatus;
import com.movedriverdriver.driver.DriverOngoingAct;
import com.movedriverdriver.driver.DriverTripHistoryAct;
...
import com.movedriverdriver.service.APIService_Retrofit_JSON_NoProgress;
import com.movedriverdriver.service.BackgroundCoreConfig;
import com.movedriverdriver.service.CoreClient;
import com.movedriverdriver.service.RetrofitCallbackClass;
...
import static com.movedriverdriver.MainActivity.mgpsDialog;
import static com.movedriverdriver.util.ConstantsKt.API_BASE;
import static com.movedriverdriver.util.ConstantsKt.DEFAULT_CITY_NAME;
import static com.movedriverdriver.util.ConstantsKt.IS_BUISNESS_KEY;
import static com.movedriverdriver.util.ConstantsKt.LANG;
import static com.movedriverdriver.util.ConstantsKt.MODEL_DETAILS;
import static com.movedriverdriver.util.ConstantsKt.PASS_ID;
import static com.movedriverdriver.util.ConstantsKt.PASS_PAYMENT_OPTION;
import static com.movedriverdriver.util.ConstantsKt.SERVICE_DETAILS;
                ...
                try {
                    ...
                    if (json.getInt("status") == 1) {
                        ...
                        if (array.getJSONObject(0).has("chat_feature")) {
                            SessionSave.saveSession("chat_feature", array.getJSONObject(0).getString("chat_feature"), SplashActivity.this);
                        }
                        ...
                        if (array.getJSONObject(0).has("is_signature_enable")){
                            SessionSave.saveSession("is_signature_enable", array.getJSONObject(0).getString("is_signature_enable"), SplashActivity.this);
                        }
