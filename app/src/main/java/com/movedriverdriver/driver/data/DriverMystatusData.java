...
public class DriverMystatusData {
    // timer_data
    ...
    public void setDriverWaitingHr(String driverWaitingHr) {
        DriverMystatusData.driverWaitingHr = driverWaitingHr;
    }
    ...
    public DriverMystatusData(Context con) {
        this.ctx = con;
    }
    ...
    public void setdropLoc(String p_dropLoc) {
        DriverMystatusData.p_dropLoc = p_dropLoc;
    }
    ...
    public void settaxiId(String p_taxiId) {
        DriverMystatusData.p_taxiId = p_taxiId;
    }
    ...
    public void setpickupLoc(String p_pickupLoc) {
        DriverMystatusData.p_pickupLoc = p_pickupLoc;
    }
    ...
    public void setdistance(String p_distance) {
        DriverMystatusData.p_distance = p_distance;
    }
    ...
    public void setcompanyId(String p_companyId) {
        DriverMystatusData.p_companyId = p_companyId;
    }
    ...
    public void settripId(String p_tripId) {
        DriverMystatusData.p_tripId = p_tripId;
    }
    ...
    public void setpassengerId(String p_passengerId) {
        DriverMystatusData.p_passengerId = p_passengerId;
    }
