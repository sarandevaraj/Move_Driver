...
import com.movedriverdriver.driver.DriverMyFleetAct;
import com.movedriverdriver.driver.data.DriverFleetData;
...
public class DriverMyFleetListAdapter extends RecyclerView.Adapter<DriverMyFleetListAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, final int position) {
        ...
        if (data.get(position).getprimaryFleet().equals("1")) {
            ...
            holder.primary_txt.setTextColor(DriverCL.getColor(mContext,R.color.green_new));
        } else {
            holder.primary_txt.setTextColor(DriverCL.getColor(mContext,R.color.white));
