...
public class DriverRoundedImageView extends AppCompatImageView {
    public DriverRoundedImageView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public DriverRoundedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DriverRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
