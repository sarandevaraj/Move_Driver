...
typealias Listener = (String,String) -> Unit

class PayModeSelection(private val listener: Listener) : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return  View.inflate(requireContext(),R.layout.fragment_pay_mode_selection,null)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        FontHelper.applyFont(requireActivity(), requireActivity().findViewById(R.id.linear))
