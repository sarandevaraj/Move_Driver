...
import com.taximobility.driver.adapter.DriverPastBookingAdapter;
import com.taximobility.driver.adapter.DriverUpcomingAdapter;
...
public class DriverTripHistory extends Fragment implements DriverUpcomingAdapterInterface {
    ...
    private List<DriverUpcomingResponse.PastBooking> pastData = new ArrayList<>();
    ...
    private void callUpComingData() {
        ...
        LoginResponse.enqueue(new DriverRetrofitCallbackClass<>(getActivity(), new Callback<DriverUpcomingResponse>() {
            ...
            @Override
            public void onResponse(Call<DriverUpcomingResponse> call, Response<DriverUpcomingResponse> response) {
                closeDialog();
            ...
            @Override
            public void onFailure(Call<DriverUpcomingResponse> call, Throwable t) {
                t.printStackTrace();
    ...
    public void showDialog() {
        try {
            if (DriverNetworkStatus.isOnline(getActivity())) {
                ...
                Glide.with(DriverTripHistory.this)
    ...
    @Override
    public void updateUpcomingAdapter(List<? extends DriverUpcomingResponse.PastBooking> data, int clickedPosition) {
