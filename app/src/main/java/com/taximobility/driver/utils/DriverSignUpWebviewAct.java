...
public class DriverSignUpWebviewAct extends DriverBaseActivity {
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         Glide.with(DriverSignUpWebviewAct.this)
...
//         encodeSTr = HttpRequest.Base64.encodeBytes(driverId.getBytes());
         ...
         link_2_attach = link_1 + encodeSTr + "/?lang=" + lang_Str;
          DriverSystems.out.println("cherry_chk" + "--" + DriverSessionSave.getSession("Id", DriverSignUpWebviewAct.this) + "--lan"
                 + DriverSessionSave.getSession("Lang", DriverSignUpWebviewAct.this) + "--" + driverId + "--" + encodeSTr + "--p;'--  **"
