...
public class SettlementHistoryActivityDriver extends DriverBaseActivity {
    ...
    private List<DriverListClass> pastData = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DirverColorchange.ChangeColor((ViewGroup) (((ViewGroup) SettlementHistoryActivityDriver.this
                .findViewById(android.R.id.content)).getChildAt(0)), SettlementHistoryActivityDriver.this);
        ...
        btn_req.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(SettlementHistoryActivityDriver.this, DriverSettlementDetail.class));
...
//        CoreClient client = new ServiceGenerator(SettlementHistoryActivity.this, false).createService(CoreClient.class);
        ...
        settlementHistoryDataCall.enqueue(new DriverRetrofitCallbackClass<>(SettlementHistoryActivityDriver.this, new Callback<DriverSettlementHistoryData>() {
            ...
            public void onResponse(Call<DriverSettlementHistoryData> call, Response<DriverSettlementHistoryData> response) {
            ...
            public void onFailure(Call<DriverSettlementHistoryData> call, Throwable t) {
