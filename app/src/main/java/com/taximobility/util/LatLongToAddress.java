...
//        // TODO Auto-generated method stub
//        try {
//            Systems.out.println("address size11:" + latitude + "%$#" + longitude);
//
...
//                }
//            } else {
//                Systems.out.println("address size:@V" + addresses.size());
...
//            Systems.out.println("____SDD____3d_" + result + "SSS" + isSuccess);
...
////                HomePage.sf.setPickupLocTxt(object.getString("formatted_address"));
...
//            if (mContext != null) {
//                if (!NetworkStatus.isOnline(mContext))
//                    CToast.ShowToast(mContext, mContext.getString(R.string.check_internet_connection));
//            }
//        }
//    }
//}