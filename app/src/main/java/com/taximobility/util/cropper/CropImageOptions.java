...
public class CropImageOptions implements Parcelable {
     ...
     */
    public com.taximobility.util.cropper.CropImageView.CropShape cropShape;
     ...
     */
    public com.taximobility.util.cropper.CropImageView.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public com.taximobility.util.cropper.CropImageView.ScaleType scaleType;
     ...
     */
    public com.taximobility.util.cropper.CropImageView.RequestSizeOptions outputRequestSizeOptions;
    ...
    public CropImageOptions() {
        ...
        cropShape = com.taximobility.util.cropper.CropImageView.CropShape.RECTANGLE;
        ...
        guidelines = com.taximobility.util.cropper.CropImageView.Guidelines.ON_TOUCH;
        scaleType = com.taximobility.util.cropper.CropImageView.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = com.taximobility.util.cropper.CropImageView.RequestSizeOptions.NONE;
        noOutputImage = false;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = com.taximobility.util.cropper.CropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = com.taximobility.util.cropper.CropImageView.Guidelines.values()[in.readInt()];
        scaleType = com.taximobility.util.cropper.CropImageView.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = com.taximobility.util.cropper.CropImageView.RequestSizeOptions.values()[in.readInt()];
