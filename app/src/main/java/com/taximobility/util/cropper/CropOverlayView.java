...
public class CropOverlayView extends View {
     ...
     */
    private com.taximobility.util.cropper.CropImageView.Guidelines mGuidelines;

    /**
     * The shape of the cropping area - rectangle/circular.
     */
    private com.taximobility.util.cropper.CropImageView.CropShape mCropShape;
    ...
    public void resetCropOverlayView() {
        if (initializedCropWindow) {
            setCropWindowRect(com.taximobility.util.cropper.BitmapUtils.EMPTY_RECT_F);
            initCropWindow();
            invalidate();
        }
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public com.taximobility.util.cropper.CropImageView.CropShape getCropShape() {
        return mCropShape;
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public void setCropShape(com.taximobility.util.cropper.CropImageView.CropShape cropShape) {
        if (mCropShape != cropShape) {
            mCropShape = cropShape;
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17) {
                if (mCropShape == com.taximobility.util.cropper.CropImageView.CropShape.OVAL) {
     ...
     */
    public com.taximobility.util.cropper.CropImageView.Guidelines getGuidelines() {
        return mGuidelines;
    }
     ...
     */
    public void setGuidelines(com.taximobility.util.cropper.CropImageView.Guidelines guidelines) {
    ...
    public void setInitialCropWindowRect(Rect rect) {
        mInitialCropWindowRect.set(rect != null ? rect : com.taximobility.util.cropper.BitmapUtils.EMPTY_RECT);
        if (initializedCropWindow) {
            initCropWindow();
            invalidate();
    ...
    private void initCropWindow() {
        ...
        float leftLimit = Math.max(com.taximobility.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float topLimit = Math.max(com.taximobility.util.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float rightLimit = Math.min(com.taximobility.util.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottomLimit = Math.min(com.taximobility.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCropWindowHandler.showGuidelines()) {
            ...
            if (mGuidelines == com.taximobility.util.cropper.CropImageView.Guidelines.ON) {
                drawGuidelines(canvas);
            } else if (mGuidelines == com.taximobility.util.cropper.CropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        float left = Math.max(com.taximobility.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float top = Math.max(com.taximobility.util.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float right = Math.min(com.taximobility.util.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottom = Math.min(com.taximobility.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());

        if (mCropShape == com.taximobility.util.cropper.CropImageView.CropShape.RECTANGLE) {
            ...
            mPath.reset();
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17 && mCropShape == com.taximobility.util.cropper.CropImageView.CropShape.OVAL) {
    ...
    private void drawCorners(Canvas canvas) {
        if (mBorderCornerPaint != null) {
            ...
            float w = cornerWidth / 2 + (mCropShape == com.taximobility.util.cropper.CropImageView.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
    ...
    private boolean calculateBounds(RectF rect) {
        ...
        float left = com.taximobility.util.cropper.BitmapUtils.getRectLeft(mBoundsPoints);
        float top = com.taximobility.util.cropper.BitmapUtils.getRectTop(mBoundsPoints);
        float right = com.taximobility.util.cropper.BitmapUtils.getRectRight(mBoundsPoints);
        float bottom = com.taximobility.util.cropper.BitmapUtils.getRectBottom(mBoundsPoints);
