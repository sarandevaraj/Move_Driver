...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, BitmapLoadingWorkerTask.Result> {
    ...
    public BitmapLoadingWorkerTask(com.taximobility.util.cropper.CropImageView cropImageView, Uri uri) {
        mUri = uri;
    ...
    protected Result doInBackground(Void... params) {
        try {
            if (!isCancelled()) {
                ...
                com.taximobility.util.cropper.BitmapUtils.BitmapSampled decodeResult =
                        com.taximobility.util.cropper.BitmapUtils.decodeSampledBitmap(mContext, mUri, mWidth, mHeight);

                if (!isCancelled()) {

                    com.taximobility.util.cropper.BitmapUtils.RotateBitmapResult rotateResult =
                            com.taximobility.util.cropper.BitmapUtils.rotateBitmapByExif(decodeResult.bitmap, mContext, mUri);
