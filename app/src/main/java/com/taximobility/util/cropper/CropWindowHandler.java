...
final class CropWindowHandler {
     ...
     */
    public void setInitialAttributeValues(com.taximobility.util.cropper.CropImageOptions options) {
     ...
     */
    public CropWindowMoveHandler getMoveHandler(float x, float y, float targetRadius, com.taximobility.util.cropper.CropImageView.CropShape cropShape) {
