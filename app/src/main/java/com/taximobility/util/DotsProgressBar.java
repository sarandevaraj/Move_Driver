...
/**
 * This class used to show the dot progress in requesting taxi page in gray and white color dots.
 */
...
//        mPaint.setColor(getResources().getColor(R.color.mapbox_fill_red));
        start();
    }
