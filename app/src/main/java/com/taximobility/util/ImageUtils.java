...
/**
 * This class is contains many method to perform the image based process.<br>
 * Methods to get the selected image URL,Convert the image from URI format to bitmap.<br>
 * Convert the image from file type to bitmap, from drawable to bitmap. Get selected image angle.</br>
 */
