...
//import com.taximobility.data.apiData.DeviceInfo
...
//                    getAppVersionCode(), getAppVersionName(), getCurrentTime(), "1", deviceToken = SessionSave.getSession(TaxiUtil.DEVICE_TOKEN, context), deviceId = getDeviceID(context))
//            return deviceInfo
//        } catch (E: Exception) {
