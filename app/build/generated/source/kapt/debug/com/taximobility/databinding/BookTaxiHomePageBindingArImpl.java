...
public class BookTaxiHomePageBindingArImpl extends BookTaxiHomePageBinding implements com.taximobility.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.fav_bot_lay, 9);
        sViewsWithIds.put(R.id.txt_skip_drop_lay, 10);
        sViewsWithIds.put(R.id.img_iv_line, 11);
        sViewsWithIds.put(R.id.car_model_view, 12);
    }
    // views
    // variables
    @Nullable
    ...
    public BookTaxiHomePageBindingArImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private BookTaxiHomePageBindingArImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.FrameLayout) bindings[8]
            , (android.widget.LinearLayout) bindings[2]
            , (com.taximobility.bookingmodule.utils.CarModelsView) bindings[12]
        ...
        setRootTag(root);
        // listeners
        mCallback11 = new com.taximobility.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.txtSkipDrop.setOnClickListener(mCallback11);
        }
