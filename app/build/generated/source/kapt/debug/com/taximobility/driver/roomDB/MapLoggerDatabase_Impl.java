    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoGoogleMaplogger.equals(_existingGoogleMaplogger)) {
          throw new IllegalStateException("Migration didn't properly handle google_maplogger(com.taximobility.driver.roomDB.GoogleMapModel).\n"
        ...
        if (! _infoMapboxMaplogger.equals(_existingMapboxMaplogger)) {
          throw new IllegalStateException("Migration didn't properly handle mapbox_maplogger(com.taximobility.driver.roomDB.MapboxModel).\n"
        ...
        if (! _infoGeocodeLogger.equals(_existingGeocodeLogger)) {
          throw new IllegalStateException("Migration didn't properly handle geocode_logger(com.taximobility.driver.roomDB.GeocoderModel).\n"
                  + " Expected:\n" + _infoGeocodeLogger + "\n"
