...
public class RoundedImageSOS extends AppCompatImageView {
    public RoundedImageSOS(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public RoundedImageSOS(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedImageSOS(Context context, AttributeSet attrs, int defStyle) {
