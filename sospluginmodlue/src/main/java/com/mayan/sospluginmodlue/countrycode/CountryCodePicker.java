...
//                int defaultCountryCode = a.getInteger(R.styleable.CountryCodePicker_defaultCode, -1);
            ...
            textView_selectedCountry.setText(CURRENT_COUNTRY_CODE);
            defaultCountryNameCode = CURRENT_COUNTRY_ISO_CODE;//IN
            defaultCountryCode = Integer.parseInt(CURRENT_COUNTRY_CODE.replace("+", ""));//+91
        } finally {
            a.recycle();
        }
