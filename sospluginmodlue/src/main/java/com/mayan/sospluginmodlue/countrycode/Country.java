...
public class Country {
    ...
    public static List<Country> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new Country("mf", "590", "Saint Martin"));
        countries.add(new Country("mc", "377", "Monaco"));
        countries.add(new Country("mn", "976", "Mongolia"));

        countries.add(new Country("mp", "670", "Northern Mariana Islands"));
        ...
        countries.add(new Country("ps", "970", "Palestinian Territory, Occupied"));
        ...
        countries.add(new Country("sj", "47", "Svalbard and Jan Mayen"));
    ...
    public static List<Country> getLibraryMasterCountriesTraditionalChinese() {
        ...
        countries.add(new Country("dz", "213", "阿爾及利亞"));
        countries.add(new Country("ad", "376", "安道爾"));
        countries.add(new Country("ao", "244", "安哥拉"));
        countries.add(new Country("aq", "672", "南極洲"));
        countries.add(new Country("ar", "54", "阿根廷"));
        countries.add(new Country("am", "374", "亞美尼亞"));
        countries.add(new Country("aw", "297", "阿魯巴"));
        countries.add(new Country("au", "61", "澳大利亞"));
        countries.add(new Country("at", "43", "奧地利"));
        countries.add(new Country("az", "994", "亞塞拜然"));
        countries.add(new Country("bh", "973", "巴林"));
        countries.add(new Country("bd", "880", "孟加拉"));
        countries.add(new Country("by", "375", "白俄羅斯"));
        countries.add(new Country("be", "32", "比利時"));
        countries.add(new Country("bz", "501", "貝里斯"));
        countries.add(new Country("bj", "229", "貝南"));
        countries.add(new Country("bt", "975", "不丹"));
        countries.add(new Country("bo", "591", "玻利維亞多民族國"));
        countries.add(new Country("ba", "387", "波士尼亞赫塞哥維納"));
        countries.add(new Country("bw", "267", "波札那"));
        countries.add(new Country("br", "55", "巴西"));
        countries.add(new Country("bn", "673", "汶萊達魯薩蘭國"));
        countries.add(new Country("bg", "359", "保加利亞"));
        countries.add(new Country("bf", "226", "布吉納法索"));
        countries.add(new Country("mm", "95", "緬甸"));
        countries.add(new Country("bi", "257", "布隆迪"));
        countries.add(new Country("kh", "855", "柬埔寨"));
        countries.add(new Country("cm", "237", "喀麥隆"));
        countries.add(new Country("ca", "1", "加拿大"));
        countries.add(new Country("cv", "238", "維德角"));
        countries.add(new Country("cf", "236", "中非共和國"));
        countries.add(new Country("td", "235", "查德"));
        countries.add(new Country("cl", "56", "智利"));
        countries.add(new Country("cn", "86", "中國"));
        countries.add(new Country("cx", "61", "聖誕島"));
        countries.add(new Country("cc", "61", "科科斯"));
        countries.add(new Country("co", "57", "哥倫比亞"));
        countries.add(new Country("km", "269", "科摩羅"));
        countries.add(new Country("cg", "242", "剛果"));
        countries.add(new Country("cd", "243", "剛果民主共和國中"));
        countries.add(new Country("ck", "682", "科克群島"));
        countries.add(new Country("cr", "506", "哥斯大黎加"));
        countries.add(new Country("hr", "385", "克羅埃西亞"));
        countries.add(new Country("cu", "53", "古巴"));
        countries.add(new Country("cy", "357", "賽普勒斯"));
        countries.add(new Country("cz", "420", "捷克共和國"));
        countries.add(new Country("dk", "45", "丹麥"));
        countries.add(new Country("dj", "253", "吉布地"));
        countries.add(new Country("tl", "670", "東帝汶"));
        countries.add(new Country("ec", "593", "厄瓜多爾"));
        countries.add(new Country("eg", "20", "埃及"));
        countries.add(new Country("sv", "503", "薩爾瓦多"));
        countries.add(new Country("gq", "240", "赤道幾內亞"));
        countries.add(new Country("er", "291", "厄立特里亞"));
        countries.add(new Country("ee", "372", "愛沙尼亞"));
        countries.add(new Country("et", "251", "衣索比亞"));
        countries.add(new Country("fk", "500", "福克蘭群島（福克蘭群島）"));
        countries.add(new Country("fo", "298", "法羅群島"));
        countries.add(new Country("fj", "679", "斐"));
        countries.add(new Country("fi", "358", "芬蘭"));
        countries.add(new Country("fr", "33", "法國"));
        countries.add(new Country("gf", "594", "法屬圭亞那"));
        countries.add(new Country("pf", "689", "法屬波利尼西亞"));
        countries.add(new Country("ga", "241", "加蓬"));
        countries.add(new Country("gm", "220", "甘比亞"));
        countries.add(new Country("ge", "995", "格魯吉亞"));
        countries.add(new Country("de", "49", "德國"));
        countries.add(new Country("gh", "233", "迦納"));
        countries.add(new Country("gi", "350", "直布羅陀"));
        countries.add(new Country("gr", "30", "希臘"));
        countries.add(new Country("gl", "299", "格陵蘭"));
        countries.add(new Country("gt", "502", "瓜地馬拉"));
        countries.add(new Country("gn", "224", "幾內亞"));
        countries.add(new Country("gw", "245", "幾內亞比索"));
        countries.add(new Country("gy", "592", "圭亞那"));
        countries.add(new Country("ht", "509", "海地"));
        countries.add(new Country("hn", "504", "洪都拉斯"));
        countries.add(new Country("hk", "852", "香港"));
        countries.add(new Country("hu", "36", "匈牙利"));
        countries.add(new Country("in", "91", "印度"));
        countries.add(new Country("id", "62", "印尼"));
        countries.add(new Country("ir", "98", "伊朗伊斯蘭共和國"));
        countries.add(new Country("iq", "964", "伊拉克"));
        countries.add(new Country("ie", "353", "愛爾蘭"));
        countries.add(new Country("im", "44", "馬恩島"));
        countries.add(new Country("il", "972", "以色列"));
        countries.add(new Country("it", "39", "義大利"));
        countries.add(new Country("ci", "225", "象牙海岸者;象牙海岸"));
        countries.add(new Country("jp", "81", "日本"));
        countries.add(new Country("jo", "962", "約旦"));
        countries.add(new Country("kz", "7", "哈薩克"));
        countries.add(new Country("ke", "254", "肯亞"));
        countries.add(new Country("ki", "686", "吉里巴斯"));
        countries.add(new Country("kw", "965", "科威特"));
        countries.add(new Country("kg", "996", "吉爾吉斯斯坦"));
        countries.add(new Country("la", "856", "老撾人民氏民主共和國"));
        countries.add(new Country("lv", "371", "拉脫維亞"));
        countries.add(new Country("lb", "961", "黎巴嫩"));
        countries.add(new Country("ls", "266", "賴索托"));
        countries.add(new Country("lr", "231", "賴比瑞亞"));
        countries.add(new Country("ly", "218", "利比亞"));
        countries.add(new Country("li", "423", "列支敦士登"));
        countries.add(new Country("lt", "370", "立陶宛"));
        countries.add(new Country("lu", "352", "盧森堡"));
        countries.add(new Country("mo", "853", "澳門"));
        countries.add(new Country("mk", "389", "馬其頓，前南斯拉夫共和國"));
        countries.add(new Country("mg", "261", "馬達加斯加"));
        countries.add(new Country("mw", "265", "馬拉威"));
        countries.add(new Country("my", "60", "馬來西亞"));
        countries.add(new Country("mv", "960", "馬爾地夫"));
        countries.add(new Country("ml", "223", "馬里"));
        countries.add(new Country("mt", "356", "馬爾他"));
        countries.add(new Country("mh", "692", "馬紹爾群島"));
        countries.add(new Country("mq", "596", "馬提尼克"));
        countries.add(new Country("mr", "222", "茅利塔尼亞"));
        countries.add(new Country("mu", "230", "模里西斯"));
        countries.add(new Country("yt", "262", "馬約特"));
        countries.add(new Country("mx", "52", "墨西哥"));
        countries.add(new Country("fm", "691", "密克羅尼西亞聯邦"));
        countries.add(new Country("md", "373", "莫爾達瓦共和國"));
        countries.add(new Country("mc", "377", "摩納哥"));
        countries.add(new Country("mn", "976", "蒙古"));
        countries.add(new Country("me", "382", "黑山"));
        countries.add(new Country("ma", "212", "摩洛哥"));
        countries.add(new Country("mz", "258", "莫三比克"));
        countries.add(new Country("na", "264", "納米比亞"));
        countries.add(new Country("nr", "674", "諾魯"));
        countries.add(new Country("np", "977", "尼泊爾"));
        countries.add(new Country("nl", "31", "荷蘭"));
        countries.add(new Country("nc", "687", "新赫里多尼亞"));
        countries.add(new Country("nz", "64", "紐西蘭"));
        countries.add(new Country("ni", "505", "尼加拉瓜"));
        countries.add(new Country("ne", "227", "尼日爾"));
        countries.add(new Country("ng", "234", "奈及利亞"));
        countries.add(new Country("nu", "683", "紐埃"));
        countries.add(new Country("kp", "850", "韓國，朝鮮民主主義人民共和國氏共和國"));
        countries.add(new Country("no", "47", "挪威"));
        countries.add(new Country("om", "968", "阿曼"));
        countries.add(new Country("pk", "92", "巴基斯坦"));
        countries.add(new Country("pw", "680", "帛琉"));
        countries.add(new Country("pa", "507", "巴拿馬"));
        countries.add(new Country("pg", "675", "巴布亞紐幾內亞"));
        countries.add(new Country("py", "595", "巴拉圭"));
        countries.add(new Country("pe", "51", "秘魯"));
        countries.add(new Country("ph", "63", "菲律賓"));
        countries.add(new Country("pn", "870", "皮特凱恩"));
        countries.add(new Country("pl", "48", "波蘭"));
        countries.add(new Country("pt", "351", "葡萄牙"));
        countries.add(new Country("pr", "1", "波多黎各"));
        countries.add(new Country("qa", "974", "卡達"));
        countries.add(new Country("re", "262", "團圓"));
        countries.add(new Country("ro", "40", "羅馬尼亞"));
        countries.add(new Country("ru", "7", "俄羅斯聯邦"));
        countries.add(new Country("rw", "250", "盧旺達"));
        countries.add(new Country("bl", "590", "聖巴泰勒米"));
        countries.add(new Country("ws", "685", "薩摩亞"));
        countries.add(new Country("sm", "378", "聖馬利諾"));
        countries.add(new Country("st", "239", "聖多美及普林西比島"));
        countries.add(new Country("sa", "966", "沙烏地阿拉伯"));
        countries.add(new Country("sn", "221", "塞內加爾"));
        countries.add(new Country("rs", "381", "塞爾維亞"));
        countries.add(new Country("sc", "248", "塞席爾"));
        countries.add(new Country("sl", "232", "獅子山"));
        countries.add(new Country("sg", "65", "新加坡"));
        countries.add(new Country("sk", "421", "斯洛伐克"));
        countries.add(new Country("si", "386", "斯洛維尼亞"));
        countries.add(new Country("sb", "677", "所羅門群島"));
        countries.add(new Country("so", "252", "索馬里"));
        countries.add(new Country("za", "27", "南非"));
        countries.add(new Country("kr", "82", "韓國"));
        countries.add(new Country("es", "34", "西班牙"));
        countries.add(new Country("lk", "94", "斯里蘭卡"));
        countries.add(new Country("sh", "290", "聖赫勒拿島，阿森松和特裡斯坦 - 達庫尼亞群島"));
        countries.add(new Country("pm", "508", "聖皮爾和密克隆"));
        countries.add(new Country("sd", "249", "蘇丹"));
        countries.add(new Country("sr", "597", "蘇利南"));
        countries.add(new Country("sz", "268", "史瓦濟蘭"));
        countries.add(new Country("se", "46", "瑞典"));
        countries.add(new Country("ch", "41", "瑞士"));
        countries.add(new Country("sy", "963", "阿拉伯敘利亞共和國"));
        countries.add(new Country("tw", "886", "臺灣省中國"));
        countries.add(new Country("tj", "992", "塔吉克斯坦"));
        countries.add(new Country("tz", "255", "坦尚尼亞聯合共和國"));
        countries.add(new Country("th", "66", "泰國"));
        countries.add(new Country("tg", "228", "多哥"));
        countries.add(new Country("tk", "690", "托克勞"));
        countries.add(new Country("to", "676", "東加"));
        countries.add(new Country("tn", "216", "突尼斯"));
        countries.add(new Country("tr", "90", "火雞"));
        countries.add(new Country("tm", "993", "土庫曼斯坦"));
        countries.add(new Country("tv", "688", "吐瓦魯"));
        countries.add(new Country("ae", "971", "阿拉伯聯合大公國"));
        countries.add(new Country("ug", "256", "烏干達"));
        countries.add(new Country("gb", "44", "英國"));
        countries.add(new Country("ua", "380", "烏克蘭"));
        countries.add(new Country("uy", "598", "烏拉圭"));
        countries.add(new Country("us", "1", "美國"));
        countries.add(new Country("uz", "998", "烏茲別克斯坦"));
        countries.add(new Country("vu", "678", "瓦努阿圖"));
        countries.add(new Country("va", "39", "教廷（梵蒂岡城國）"));
        countries.add(new Country("ve", "58", "委內瑞拉玻利瓦爾省共和國"));
        countries.add(new Country("vn", "84", "越南"));
        countries.add(new Country("wf", "681", "瓦利斯群島和富圖納群島"));
    ...
    public static List<Country> getLibraryMasterCountriesKorean() {
        ...
        countries.add(new Country("al", "355", "알바니아"));
        countries.add(new Country("dz", "213", "알제리"));
        countries.add(new Country("ad", "376", "안도라"));
        countries.add(new Country("ao", "244", "앙골라"));
        countries.add(new Country("ai", "1", "앵귈라"));
        countries.add(new Country("aq", "672", "남극"));
        countries.add(new Country("ag", "1", "앤티가 바부다"));
        countries.add(new Country("ar", "54", "아르헨티나"));
        countries.add(new Country("am", "374", "아르메니아"));
        countries.add(new Country("aw", "297", "아루바"));
        countries.add(new Country("au", "61", "오스트레일리아 (호주)"));
        countries.add(new Country("at", "43", "오스트리아"));
        countries.add(new Country("az", "994", "아제르바이잔"));
        countries.add(new Country("bs", "1", "바하마"));
        countries.add(new Country("bh", "973", "바레인"));
        countries.add(new Country("bd", "880", "방글라데시"));
        countries.add(new Country("bb", "1", "Barbados"));
        countries.add(new Country("by", "375", "벨라루스"));
        countries.add(new Country("be", "32", "벨기에"));
        countries.add(new Country("bz", "501", "Belize"));
        countries.add(new Country("bj", "229", "Benin"));
        countries.add(new Country("bm", "1", "버뮤다"));
        countries.add(new Country("bt", "975", "부탄"));
        countries.add(new Country("bo", "591", "볼리비아"));
        countries.add(new Country("ba", "387", "보스니아 헤르체고비나"));
        countries.add(new Country("bw", "267", "보츠와나"));
        countries.add(new Country("br", "55", "브라질"));
        countries.add(new Country("vg", "1", "영국령 버진아일랜드"));
        countries.add(new Country("bn", "673", "브루나이"));
        countries.add(new Country("bg", "359", "불가리아"));
        countries.add(new Country("bf", "226", "부르키나파소"));
        countries.add(new Country("mm", "95", "미얀마"));
        countries.add(new Country("bi", "257", "부룬디"));
        countries.add(new Country("kh", "855", "캄보디아"));
        countries.add(new Country("cm", "237", "카메룬"));
        countries.add(new Country("ca", "1", "캐나다"));
        countries.add(new Country("cv", "238", "카보베르데"));
        countries.add(new Country("ky", "1", "케이맨 제도"));
        countries.add(new Country("cf", "236", "중앙아프리카공화국"));
        countries.add(new Country("td", "235", "차드"));
        countries.add(new Country("cl", "56", "칠레"));
        countries.add(new Country("cn", "86", "중국"));
        countries.add(new Country("cx", "61", "크리스마스 섬"));
        countries.add(new Country("cc", "61", "코코스 제도"));
        countries.add(new Country("co", "57", "콜롬비아"));
        countries.add(new Country("km", "269", "코모로"));
        countries.add(new Country("cg", "242", "콩고"));
        countries.add(new Country("cd", "243", "콩고 민주 공화국"));
        countries.add(new Country("ck", "682", "쿡 제도"));
        countries.add(new Country("cr", "506", "코스타리카"));
        countries.add(new Country("hr", "385", "크로아티아"));
        countries.add(new Country("cu", "53", "쿠바"));
        countries.add(new Country("cy", "357", "키프러스"));
        countries.add(new Country("cz", "420", "체코"));
        countries.add(new Country("dk", "45", "덴마크"));
        countries.add(new Country("dj", "253", "주부티"));
        countries.add(new Country("dm", "1", "도미니카"));
        countries.add(new Country("do", "1", "도미니카 공화국"));
        countries.add(new Country("tl", "670", "동티모르"));
        countries.add(new Country("ec", "593", "에콰도르"));
        countries.add(new Country("eg", "20", "이집트"));
        countries.add(new Country("sv", "503", "엘 살바도르"));
        countries.add(new Country("gq", "240", "적도 기니"));
        countries.add(new Country("er", "291", "에리트레아"));
        countries.add(new Country("ee", "372", "에스토니아"));
        countries.add(new Country("et", "251", "에티오피아"));
        countries.add(new Country("fk", "500", "포클랜드 제도 (말비나스 군도)"));
        countries.add(new Country("fo", "298", "페로 제도"));
        countries.add(new Country("fj", "679", "피지"));
        countries.add(new Country("fi", "358", "핀란드"));
        countries.add(new Country("fr", "33", "프랑스"));
        countries.add(new Country("gf", "594", "프랑스령 기아나"));
        countries.add(new Country("pf", "689", "프랑스령 폴리네시아"));
        countries.add(new Country("ga", "241", "가봉"));
        countries.add(new Country("gm", "220", "감비아"));
        countries.add(new Country("ge", "995", "조지아"));
        countries.add(new Country("de", "49", "독일"));
        countries.add(new Country("gh", "233", "가나"));
        countries.add(new Country("gi", "350", "지브롤터"));
        countries.add(new Country("gr", "30", "그리스"));
        countries.add(new Country("gl", "299", "그린란드"));
        countries.add(new Country("gd", "1", "그레나다"));
        countries.add(new Country("gt", "502", "과테말라"));
        countries.add(new Country("gn", "224", "기니"));
        countries.add(new Country("gw", "245", "기니비사우"));
        countries.add(new Country("gy", "592", "가이아나"));
        countries.add(new Country("ht", "509", "아이티"));
        countries.add(new Country("hn", "504", "온두라스"));
        countries.add(new Country("hk", "852", "홍콩"));
        countries.add(new Country("hu", "36", "헝가리"));
        countries.add(new Country("in", "91", "인도"));
        countries.add(new Country("id", "62", "인도네시아"));
        countries.add(new Country("ir", "98", "이란"));
        countries.add(new Country("iq", "964", "이라크"));
        countries.add(new Country("ie", "353", "아일랜드"));
        countries.add(new Country("im", "44", "맨섬"));
        countries.add(new Country("il", "972", "이스라엘"));
        countries.add(new Country("it", "39", "이탈리아(이태리)"));
        countries.add(new Country("ci", "225", "코트 디부아르"));
        countries.add(new Country("jm", "1", "자메이카"));
        countries.add(new Country("jp", "81", "일본"));
        countries.add(new Country("jo", "962", "요르단"));
        countries.add(new Country("kz", "7", "카자흐스탄"));
        countries.add(new Country("ke", "254", "케냐"));
        countries.add(new Country("ki", "686", "키리바시"));
        countries.add(new Country("kw", "965", "쿠웨이트"));
        countries.add(new Country("kg", "996", "키르기스스탄"));
        countries.add(new Country("la", "856", "라오스"));
        countries.add(new Country("lv", "371", "라트비아"));
        countries.add(new Country("lb", "961", "레바논"));
        countries.add(new Country("ls", "266", "레소토"));
        countries.add(new Country("lr", "231", "리베리아"));
        countries.add(new Country("ly", "218", "리비야"));
        countries.add(new Country("li", "423", "리히텐슈타인"));
        countries.add(new Country("lt", "370", "리투아니아"));
        countries.add(new Country("lu", "352", "뤽상부르"));
        countries.add(new Country("mo", "853", "마카오"));
        countries.add(new Country("mk", "389", "마케도니아"));
        countries.add(new Country("mg", "261", "마다가스카르"));
        countries.add(new Country("mw", "265", "말라위"));
        countries.add(new Country("my", "60", "말레이시아"));
        countries.add(new Country("mv", "960", "몰디브"));
        countries.add(new Country("ml", "223", "말리"));
        countries.add(new Country("mt", "356", "몰타"));
        countries.add(new Country("mh", "692", "마샬 군도"));
        countries.add(new Country("mq", "596", "마르티니크"));
        countries.add(new Country("mr", "222", "모리타니아"));
        countries.add(new Country("mu", "230", "모리셔스"));
        countries.add(new Country("yt", "262", "마요트"));
        countries.add(new Country("mx", "52", "멕시코"));
        countries.add(new Country("fm", "691", "미크로네시아 연방"));
        countries.add(new Country("md", "373", "몰도바"));
        countries.add(new Country("mc", "377", "모나코"));
        countries.add(new Country("mn", "976", "몽골리아"));
        countries.add(new Country("ms", "1", "몬세라트"));
        countries.add(new Country("me", "382", "몬테네그로"));
        countries.add(new Country("ma", "212", "모로코"));
        countries.add(new Country("mz", "258", "모잠비크"));
        countries.add(new Country("na", "264", "나미비아"));
        countries.add(new Country("nr", "674", "나우루"));
        countries.add(new Country("np", "977", "네팔"));
        countries.add(new Country("nl", "31", "네덜란드"));
        countries.add(new Country("nc", "687", "뉴 칼레도니아"));
        countries.add(new Country("nz", "64", "뉴질랜드"));
        countries.add(new Country("ni", "505", "니카라과"));
        countries.add(new Country("ne", "227", "니제르"));
        countries.add(new Country("ng", "234", "나이지리아"));
        countries.add(new Country("nu", "683", "니우에"));
        countries.add(new Country("kp", "850", "북한"));
        countries.add(new Country("no", "47", "노르웨이"));
        countries.add(new Country("om", "968", "오만"));
        countries.add(new Country("pk", "92", "파키스탄"));
        countries.add(new Country("pw", "680", "팔라우"));
        countries.add(new Country("pa", "507", "파나마"));
        countries.add(new Country("pg", "675", "파퓨아뉴기니"));
        countries.add(new Country("py", "595", "파라과이"));
        countries.add(new Country("pe", "51", "페루"));
        countries.add(new Country("ph", "63", "필리핀"));
        countries.add(new Country("pn", "870", "핏케언 제도"));
        countries.add(new Country("pl", "48", "폴란드"));
        countries.add(new Country("pt", "351", "포루투갈"));
        countries.add(new Country("pr", "1", "푸에르토리코"));
        countries.add(new Country("qa", "974", "카타르"));
        countries.add(new Country("re", "262", "레위니옹"));
        countries.add(new Country("ro", "40", "루마니아"));
        countries.add(new Country("ru", "7", "러시아"));
        countries.add(new Country("rw", "250", "르완다"));
        countries.add(new Country("bl", "590", "생바르텔레미"));
        countries.add(new Country("kn", "1", "세인트키츠 네비스"));
        countries.add(new Country("lc", "1", "세인트루시아"));
        countries.add(new Country("vc", "1", "세인트빈센트 그레나딘"));
        countries.add(new Country("ws", "685", "사모아"));
        countries.add(new Country("sm", "378", "산 마리노"));
        countries.add(new Country("st", "239", "상투메 프린시페"));
        countries.add(new Country("sa", "966", "사우디 아라비아"));
        countries.add(new Country("sn", "221", "세네갈"));
        countries.add(new Country("rs", "381", "세르비아"));
        countries.add(new Country("sc", "248", "세이셸"));
        countries.add(new Country("sl", "232", "시에라리온"));
        countries.add(new Country("sg", "65", "싱가포르"));
        countries.add(new Country("sx", "1", "신트마르턴"));
        countries.add(new Country("sk", "421", "슬로바키아"));
        countries.add(new Country("si", "386", "슬로베니아"));
        countries.add(new Country("sb", "677", "솔로몬 제도"));
        countries.add(new Country("so", "252", "소말리아"));
        countries.add(new Country("za", "27", "남아프리카 공화국"));
        countries.add(new Country("kr", "82", "한국 (대한민국)"));
        countries.add(new Country("es", "34", "스페인"));
        countries.add(new Country("lk", "94", "스리랑카"));
        countries.add(new Country("sh", "290", "세인트헬레나 어센션 트리스탄다쿠냐"));
        countries.add(new Country("pm", "508", "생피에르 미클롱"));
        countries.add(new Country("sd", "249", "수단"));
        countries.add(new Country("sr", "597", "수리남"));
        countries.add(new Country("sz", "268", "스와질란드"));
        countries.add(new Country("se", "46", "스웨덴"));
        countries.add(new Country("ch", "41", "스위스"));
        countries.add(new Country("sy", "963", "시리아"));
        countries.add(new Country("tw", "886", "대만 (타이완)"));
        countries.add(new Country("tj", "992", "타지키스탄"));
        countries.add(new Country("tz", "255", "탄자니아"));
        countries.add(new Country("th", "66", "태국"));
        countries.add(new Country("tg", "228", "토고"));
        countries.add(new Country("tk", "690", "토켈 라우"));
        countries.add(new Country("to", "676", "통가"));
        countries.add(new Country("tt", "1", "트리니다드 토바고"));
        countries.add(new Country("tn", "216", "튀니지"));
        countries.add(new Country("tr", "90", "터키"));
        countries.add(new Country("tm", "993", "투르크 메니스탄"));
        countries.add(new Country("tc", "1", "터크스 케이커스 제도"));
        countries.add(new Country("tv", "688", "투발루"));
        countries.add(new Country("ae", "971", "아랍 에미리트"));
        countries.add(new Country("ug", "256", "우간다"));
        countries.add(new Country("gb", "44", "영국"));
        countries.add(new Country("ua", "380", "우크라이나"));
        countries.add(new Country("uy", "598", "우루과이"));
        countries.add(new Country("us", "1", "미국"));
        countries.add(new Country("vi", "1", "미국령 버진아일랜드"));
        countries.add(new Country("uz", "998", "우즈베키스탄"));
        countries.add(new Country("vu", "678", "바누아투"));
        countries.add(new Country("va", "39", "바티칸 시국"));
        countries.add(new Country("ve", "58", "베네수엘라"));
        countries.add(new Country("vn", "84", "베트남"));
        countries.add(new Country("wf", "681", "왈리스 퓌튀나"));
        countries.add(new Country("ye", "967", "예맨"));
        countries.add(new Country("zm", "260", "잠비아"));
        countries.add(new Country("zw", "263", "짐바브웨"));
        return countries;
    }
    ...
    public static List<Country> getLibraryMasterCountriesHebrew() {
        List<Country> countries = new ArrayList<>();
        countries.add(new Country("af", "93", "אפגניסטן"));
        countries.add(new Country("al", "355", "אלבניה"));
        countries.add(new Country("dz", "213", "אלג’יריה"));
        countries.add(new Country("ad", "376", "אנדורה"));
        countries.add(new Country("ao", "244", "אנגולה"));
        countries.add(new Country("aq", "672", "אנטארקטיקה"));
        countries.add(new Country("ar", "54", "ארגנטינה"));
        countries.add(new Country("am", "374", "ארמניה"));
        countries.add(new Country("aw", "297", "ארובה"));
        countries.add(new Country("au", "61", "אוסטרליה"));
        countries.add(new Country("at", "43", "אוסטריה"));
        countries.add(new Country("az", "994", "אזרבייג׳ן"));
        countries.add(new Country("bh", "973", "בחריין"));
        countries.add(new Country("bd", "880", "בנגלדש"));
        countries.add(new Country("by", "375", "בלארוס"));
        countries.add(new Country("be", "32", "בלגיה"));
        countries.add(new Country("bz", "501", "בליז"));
        countries.add(new Country("bj", "229", "בנין"));
        countries.add(new Country("bt", "975", "בהוטן"));
        countries.add(new Country("bo", "591", "בוליביה"));
        countries.add(new Country("ba", "387", "בוסניה והרצגובינה"));
        countries.add(new Country("bw", "267", "בוטסואנה"));
        countries.add(new Country("br", "55", "ברזיל"));
        countries.add(new Country("bn", "673", "ברוניי"));
        countries.add(new Country("bg", "359", "בולגריה"));
        countries.add(new Country("bf", "226", "בורקינה פאסו"));
        countries.add(new Country("mm", "95", "מיאנמר"));
        countries.add(new Country("bi", "257", "בורונדי"));
        countries.add(new Country("kh", "855", "קמבודיה"));
        countries.add(new Country("cm", "237", "קמרון"));
        countries.add(new Country("ca", "1", "קנדה"));
        countries.add(new Country("cv", "238", "כף ורדה"));
        countries.add(new Country("cf", "236", "הרפובליקה המרכז-אפריקאית"));
        countries.add(new Country("td", "235", "צ׳אד"));
        countries.add(new Country("cl", "56", "צ׳ילה"));
        countries.add(new Country("cn", "86", "סין"));
        countries.add(new Country("cx", "61", "אי חג המולד"));
        countries.add(new Country("cc", "61", "איי קוקוס"));
        countries.add(new Country("co", "57", "קולומביה"));
        countries.add(new Country("km", "269", "קומורו"));
        countries.add(new Country("cg", "242", "הרפובליקה של קונגו"));
        countries.add(new Country("cd", "243", "הרפובליקה הדמוקרטית של קונגו"));
        countries.add(new Country("ck", "682", "איי קוק"));
        countries.add(new Country("cr", "506", "קוסטה ריקה"));
        countries.add(new Country("hr", "385", "קרואטיה"));
        countries.add(new Country("cu", "53", "קובה"));
        countries.add(new Country("cy", "357", "קפריסין"));
        countries.add(new Country("cz", "420", "צ׳כיה"));
        countries.add(new Country("dk", "45", "דנמרק"));
        countries.add(new Country("dj", "253", "ג׳יבוטי"));
        countries.add(new Country("tl", "670", "מזרח טימור"));
        countries.add(new Country("ec", "593", "אקוודור"));
        countries.add(new Country("eg", "20", "מצרים"));
        countries.add(new Country("sv", "503", "אל סלוודור"));
        countries.add(new Country("gq", "240", "ינאה המשוונית"));
        countries.add(new Country("er", "291", "אריתריאה"));
        countries.add(new Country("ee", "372", "אסטוניה"));
        countries.add(new Country("et", "251", "אתיופיה"));
        countries.add(new Country("fk", "500", "איי פוקלנד"));
        countries.add(new Country("fo", "298", "איי פרו"));
        countries.add(new Country("fj", "679", "פיג׳י"));
        countries.add(new Country("fi", "358", "פינלנד"));
        countries.add(new Country("fr", "33", "צרפת"));
        countries.add(new Country("gf", "594", "גיאנה הצרפתית"));
        countries.add(new Country("pf", "689", "פולינזיה"));
        countries.add(new Country("ga", "241", "גבון"));
        countries.add(new Country("gm", "220", "גמביה"));
        countries.add(new Country("ge", "995", "גאורגיה"));
        countries.add(new Country("de", "49", "גרמניה"));
        countries.add(new Country("gh", "233", "גאנה"));
        countries.add(new Country("gi", "350", "גיברלטר"));
        countries.add(new Country("gr", "30", "יון"));
        countries.add(new Country("gl", "299", "גרינלנד"));
        countries.add(new Country("gt", "502", "גואטמלה"));
        countries.add(new Country("gn", "224", "גינאה"));
        countries.add(new Country("gw", "245", "גינאה ביסאו"));
        countries.add(new Country("gy", "592", "גיאנה"));
        countries.add(new Country("ht", "509", "האיטי"));
        countries.add(new Country("hn", "504", "הונדורס"));
        countries.add(new Country("hk", "852", "הונג קונג"));
        countries.add(new Country("hu", "36", "הונגריה"));
        countries.add(new Country("in", "91", "הודו"));
        countries.add(new Country("id", "62", "אינדונזיה"));
        countries.add(new Country("ir", "98", "איראן"));
        countries.add(new Country("iq", "964", "עיראק"));
        countries.add(new Country("ie", "353", "אירלנד"));
        countries.add(new Country("im", "44", "האי מאן"));
        countries.add(new Country("il", "972", "ישראל"));
        countries.add(new Country("it", "39", "איטליה"));
        countries.add(new Country("ci", "225", "חוף השנהב"));
        countries.add(new Country("jp", "81", "יפן"));
        countries.add(new Country("jo", "962", "ירדן"));
        countries.add(new Country("kz", "7", "קזחסטן"));
        countries.add(new Country("ke", "254", "קניה"));
        countries.add(new Country("ki", "686", "קיריבטי"));
        countries.add(new Country("kw", "965", "כווית"));
        countries.add(new Country("kg", "996", "קירגיזסטן"));
        countries.add(new Country("la", "856", "לאוס"));
        countries.add(new Country("lv", "371", "לטביה"));
        countries.add(new Country("lb", "961", "לבנון"));
        countries.add(new Country("ls", "266", "לסוטו"));
        countries.add(new Country("lr", "231", "ליבריה"));
        countries.add(new Country("ly", "218", "לוב"));
        countries.add(new Country("li", "423", "ליכטנשטיין"));
        countries.add(new Country("lt", "370", "ליטא"));
        countries.add(new Country("lu", "352", "לוקסמבורג"));
        countries.add(new Country("mo", "853", "מקאו"));
        countries.add(new Country("mk", "389", "מקדוניה"));
        countries.add(new Country("mg", "261", "מדגסקר"));
        countries.add(new Country("mw", "265", "מלאווי"));
        countries.add(new Country("my", "60", "מלזיה"));
        countries.add(new Country("mv", "960", "האיים המלדיביים"));
        countries.add(new Country("ml", "223", "מאלי"));
        countries.add(new Country("mt", "356", "מלטה"));
        countries.add(new Country("mh", "692", "איי מרשל       "));
        countries.add(new Country("mq", "596", "מרטיניק"));
        countries.add(new Country("mr", "222", "מאוריטניה"));
        countries.add(new Country("mu", "230", "מאוריציוס"));
        countries.add(new Country("yt", "262", "מיוט"));
        countries.add(new Country("mx", "52", "מקסיקו"));
        countries.add(new Country("fm", "691", "מיקרונזיה"));
        countries.add(new Country("md", "373", "מולדובה"));
        countries.add(new Country("mc", "377", "מונאקו"));
        countries.add(new Country("mn", "976", "מונגוליה"));
        countries.add(new Country("me", "382", "מונטנגרו"));
        countries.add(new Country("ma", "212", "מרוקו"));
        countries.add(new Country("mz", "258", "מוזמביק"));
        countries.add(new Country("na", "264", "נמיביה"));
        countries.add(new Country("nr", "674", "נאורו"));
        countries.add(new Country("np", "977", "נפאל"));
        countries.add(new Country("nl", "31", "הולנד"));
        countries.add(new Country("nc", "687", "קלדוניה החדשה"));
        countries.add(new Country("nz", "64", "ניו זילנד"));
        countries.add(new Country("ni", "505", "ניקרגואה"));
        countries.add(new Country("ne", "227", "ניז׳ר"));
        countries.add(new Country("ng", "234", "ניגריה"));
        countries.add(new Country("nu", "683", "ניואה"));
        countries.add(new Country("kp", "850", "קוריאה הצפונית"));
        countries.add(new Country("no", "47", "נורבגיה"));
        countries.add(new Country("om", "968", "עומאן"));
        countries.add(new Country("pk", "92", "פקיסטן"));
        countries.add(new Country("pw", "680", "פלאו"));
        countries.add(new Country("pa", "507", "פנמה"));
        countries.add(new Country("pg", "675", "פפואה גינאה החדשה"));
        countries.add(new Country("py", "595", "פרגוואי"));
        countries.add(new Country("pe", "51", "פרו"));
        countries.add(new Country("ph", "63", "הפיליפינים"));
        countries.add(new Country("pn", "870", "איי פיטקרן"));
        countries.add(new Country("pl", "48", "פולין"));
        countries.add(new Country("pt", "351", "פורטוגל"));
        countries.add(new Country("pr", "1", "פוארטו ריקו"));
        countries.add(new Country("qa", "974", "קטאר"));
        countries.add(new Country("re", "262", "ראוניון"));
        countries.add(new Country("ro", "40", "רומניה"));
        countries.add(new Country("ru", "7", "רוסיה"));
        countries.add(new Country("rw", "250", "רואנדה"));
        countries.add(new Country("bl", "590", "סנט ברתולומיאו"));
        countries.add(new Country("ws", "685", "סמואה"));
        countries.add(new Country("sm", "378", "סן מרינו"));
        countries.add(new Country("st", "239", "סאו טומה ופרינסיפה"));
        countries.add(new Country("sa", "966", "ערב הסעודית"));
        countries.add(new Country("sn", "221", "סנגל"));
        countries.add(new Country("rs", "381", "סרביה"));
        countries.add(new Country("sc", "248", "סיישל"));
        countries.add(new Country("sl", "232", "סיירה לאונה"));
        countries.add(new Country("sg", "65", "סינגפור"));
        countries.add(new Country("sk", "421", "סלובקיה"));
        countries.add(new Country("si", "386", "סלובניה"));
        countries.add(new Country("sb", "677", "איי שלמה"));
        countries.add(new Country("so", "252", "סומליה"));
        countries.add(new Country("za", "27", "דרום אפריקה"));
        countries.add(new Country("kr", "82", "קוריאה הדרומית"));
        countries.add(new Country("es", "34", "ספרד"));
        countries.add(new Country("lk", "94", "סרי לנקה"));
        countries.add(new Country("sh", "290", "סנט הלנה, אסנשן וטריסטן דה קונה"));
        countries.add(new Country("pm", "508", "סנט פייר ומיקלון"));
        countries.add(new Country("sd", "249", "סודאן"));
        countries.add(new Country("sr", "597", "סורינאם"));
        countries.add(new Country("sz", "268", "סווזילנד"));
        countries.add(new Country("se", "46", "שבדיה"));
        countries.add(new Country("ch", "41", "שווייץ"));
        countries.add(new Country("sy", "963", "סוריה"));
        countries.add(new Country("tw", "886", "טייוואן"));
        countries.add(new Country("tj", "992", "טג׳יקיסטן"));
        countries.add(new Country("tz", "255", "טנזניה"));
        countries.add(new Country("th", "66", "תאילנד"));
        countries.add(new Country("tg", "228", "טוגו"));
        countries.add(new Country("tk", "690", "טוקלאו"));
        countries.add(new Country("to", "676", "טונגה"));
        countries.add(new Country("tn", "216", "תוניסיה"));
        countries.add(new Country("tr", "90", "טורקיה"));
        countries.add(new Country("tm", "993", "טורקמניסטן"));
        countries.add(new Country("tv", "688", "טובאלו"));
        countries.add(new Country("ae", "971", "איחוד האמירויות הערביות"));
        countries.add(new Country("ug", "256", "אוגנדה"));
        countries.add(new Country("gb", "44", "הממלכה המאוחדת"));
        countries.add(new Country("ua", "380", "אוקראינה"));
        countries.add(new Country("uy", "598", "אורוגוואי"));
        countries.add(new Country("us", "1", "ארצות הברית"));
        countries.add(new Country("uz", "998", "אוזבקיסטן"));
        countries.add(new Country("vu", "678", "ונואטו"));
        countries.add(new Country("va", "39", "עיר הותיקן"));
        countries.add(new Country("ve", "58", "ונצואלה"));
        countries.add(new Country("vn", "84", "וייטנאם"));
        countries.add(new Country("wf", "681", "ואליס ופוטונה"));
